...
snakemake                                                          \
    ...
    --cluster-config /home/800/bxs800/scripts/snakemake/recepies/trimSPADES/cluster.yaml                             \
    --local-cores ${PBS_NCPUS:-1}                                  \
    --js /home/800/bxs800/scripts/snakemake/recepies/trimSPADES/jobscript.sh                                         \
    --nolock                                                       \
    --rerun-incomplete                                             \
    --keep-going                                                   \
    --cluster "$QSUB"                                              \
